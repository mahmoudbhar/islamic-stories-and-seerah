...
// مفتاح التخزين الموحد لضمان حفظ حالة القراءة والمفضلة بنجاح
...
function loadStories() {
    ...
    if (saved) {
        ...
        // دمج البيانات المحفوظة مع البيانات الأصلية لضمان ظهور أي قصة جديدة
...
if (increaseFontBtn) {
    increaseFontBtn.onclick = () => {
        if (currentFontScale < 1.6) {
            ...
            if (detailContent) detailContent.style.fontSize = `${1.35 * currentFontScale}rem`;
        }
    };
}
...
// ==========================================
// تشغيل وتثبيت الـ Service Worker للعمل بدون إنترنت
// ==========================================
